...
export default function LoginPage() {
  ...
  // Replicates scroll configuration listeners safely in Next.js
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      {/* Load Fonts and FontAwesome Stylesheets */}
      ...
      <div className="antialiased flex flex-col min-h-screen">
        <main className="flex-1 flex flex-col lg:flex-row w-full min-h-screen relative z-20">
          {/* Left Side Image & Branding Banner */}
          <div className="w-full lg:w-1/2 relative flex flex-col justify-center px-8 pt-24 pb-16 lg:p-20 overflow-hidden bg-brandPrimary min-h-[40vh] lg:min-h-screen lg:sticky lg:top-0">
            <img
            ...
            <div className="relative z-10 w-full max-w-lg mx-auto mt-6 lg:mx-0 lg:mt-12 animate-slide-up">
              ...
              <p className="text-white/80 text-base sm:text-lg leading-relaxed font-medium max-w-md">
                Revolutionizing your dining experience. Skip the physical line,
                secure your digital token remotely, and savor the moments that
                matter.
              </p>
            </div>
          </div>

          {/* Right Side Intercepted Login form */}
